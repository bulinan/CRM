define(function (require, exports, module) {
    ...
    exports.init = function () {
        ...
        bootstrap.bootstrap_initMain(function () {
            var jsonStr, jsonObj;
            if ($.cookie('report_opportunity_price')) {
                jsonStr = $.cookie('report_opportunity_price');
            ...
            bootstrap.bootstrap_push('未赢单机会金额-时间分布', '/report_opportunity_price');
            $('#workspace').html(Handlebars.compile(templet_report_item)({ 'USER_ID': airteams.account.USER.ID, 'USER_NAME': airteams.account.USER.NAME, 'USERS': jsonStr,'TITLE': '未赢单机会金额-时间分布','MODEL': 'report_opportunity_price' }));
            //显示span.user的text
    ...
    exports.chart_load = function (_data) {
        bootstrap.bootstrap_call('report/opportunity_price', _data, function (response) {
            ...
            var chart = amCharts.makeChart('box_main_chart', {
                ...
                "graphs": [{
                    "balloonText": "[[NAME]]<br>预计成交日期:[[DATE]]<br>预计成交金额:[[y]]",
                    "bullet": "round",
                    "lineAlpha": 0,
                    "valueField": "y",
                    "xField": "x",
    ...
    exports.component_user_submit = function () {
        ...
        $.cookie('report_opportunity_price', user_cookie);
