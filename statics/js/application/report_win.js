define(function (require, exports, module) {
    ...
    exports.init = function () {
        ...
        bootstrap.bootstrap_initMain(function () {
            var jsonStr, jsonObj;
            if ($.cookie('report_win')) {
                jsonStr = $.cookie('report_win');
            ...
            bootstrap.bootstrap_push('赢单数量-时间分布', '/report_win');
            $('#workspace').html(Handlebars.compile(templet_report_item)({ 'USER_ID': airteams.account.USER.ID, 'USER_NAME': airteams.account.USER.NAME, 'USERS': jsonStr, 'TITLE': '赢单数量-时间分布', 'MODEL': 'report_win' }));
    ...
    exports.chart_load = function (_data) {
        ...
        bootstrap.bootstrap_call('report/win', _data, function (response) {
            ...
            var chart = amCharts.makeChart('box_main_chart', {
                ...
                "graphs": [{
                    "balloonText": "[[MONTH]]成交: <b>[[COUNT]]单</b>",
                    "fillAlphas": 0.8,
                    "lineAlpha": 0.2,
                    "type": "column",
                    "valueField": "COUNT"      
