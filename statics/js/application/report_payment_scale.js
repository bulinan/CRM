define(function (require, exports, module) {
    ...
    exports.init = function () {
        ...
        bootstrap.bootstrap_initMain(function () {
            var jsonStr, jsonObj;
            if ($.cookie('report_payment_scale')) {
                jsonStr = $.cookie('report_payment_scale');
            ...
            bootstrap.bootstrap_push('合同金额-时间分布', '/report_payment_scale');
            $('#workspace').html(Handlebars.compile(templet_report_item)({ 'USER_ID': airteams.account.USER.ID, 'USER_NAME': airteams.account.USER.NAME, 'USERS': jsonStr,'TITLE': '合同金额-时间分布', 'MODEL': 'report_payment_scale' }));
            //显示span.user的text
    ...
    exports.chart_load = function (_data) {
        bootstrap.bootstrap_call('report/payment_scale',_data,function(_response){
    ...
    exports.component_user_submit = function () {
        ...
        $.cookie('report_payment_scale', user_cookie);
